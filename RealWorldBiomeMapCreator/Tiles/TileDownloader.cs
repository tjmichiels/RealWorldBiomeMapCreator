...
public class TileDownloader
{
    ...
    public async Task<Image<Rgba32>> DownloadTile(int x, int y, int zoom = 7) // int x, int y, int zoom = 7
    {
        ...
        // Onbruikbare URLs, wegens gebruik van een verkeerde layer:
        // https://mt1.google.com/vt/lyrs=m&x=65&y=42&z=7 Deze heeft ook annotaties (plaatsnamen)
        // https://mt1.google.com/vt/lyrs=p&x=65&y=42&z=7 Deze heeft ook annotaties, maar dan in het Engels
        
        // @TODO verwerkt de daadwerkelijke parameters in de URL
        
        string url = $"https://mt1.google.com/vt/lyrs=s&x=65&y=42&z={zoom}"; // satellietweergave met realistische kleuren 
        // https://mt1.google.com/vt/lyrs=t&x=65&y=42&z=7 // height map-weergave
