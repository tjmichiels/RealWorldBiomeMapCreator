...
public class SatelliteTile : ITile
{
    ...
    public SatelliteTile(Image<Rgba32> imageSource, int tileSize = 256) // TileSize is het aantal pixels dat de tile groot is (standaard 256 x 256)
    {
